...
export default {
  ...
  methods: {
    ...
    fetchConnectedChatRooms() {
      this.$axios.get('https://ec2-3-34-189-167.ap-northeast-2.compute.amazonaws.com:8080/api/v1/chat/connected-rooms')
        .then(response => {
    ...
    handleFileUpload(event) {
      ...
      this.$axios.post('https://ec2-3-34-189-167.ap-northeast-2.compute.amazonaws.com:8080/upload', formData, {
        headers: {
    ...
    fetchChatRoomDetails(roomId) {
      ...
      this.$axios.get(`https://ec2-3-34-189-167.ap-northeast-2.compute.amazonaws.com:8080/api/v1/chat/room/${roomId}`)
        .then(response => {
    ...
    fetchUserInfo() {
      this.$axios.get('https://ec2-3-34-189-167.ap-northeast-2.compute.amazonaws.com:8080/api/v1/user/info/detail')
        .then(response => {
    ...
    fetchMessages() {
      ...
      this.$axios.get(`https://ec2-3-34-189-167.ap-northeast-2.compute.amazonaws.com:8080/api/v1/chat/room/${this.chatRoomId}/messages`)
        .then(response => {

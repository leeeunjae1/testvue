...
methods: {
  ...
  fetchBudgets() {
    this.$axios.get('https://ec2-3-34-189-167.ap-northeast-2.compute.amazonaws.com:8080/api/map/listMap')
      .then(response => {
...
this.olMap.on('click', async (e) => {
  ...
  async fetchLocations() {
    try {
      const response = await axios.get('https://ec2-3-34-189-167.ap-northeast-2.compute.amazonaws.com:8080/api/map/listMap');
